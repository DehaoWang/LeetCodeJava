package com.leetcodejava.algorithms.LC94;
...
//		BinaryTree.inOrderTraversalRecursive(testMorrisBT.root);
//		BinaryTree.inOrderTraversalIterative(testMorrisBT.root);
		BinaryTree.inOrderMorris(testMorrisBT.root);
		BinaryTree.preOrderMorris(testMorrisBT.root);
	}
