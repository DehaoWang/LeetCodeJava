...
public class BinaryTree 
{
    ...
    // recursive solution
	public static Node merge2Trees(Node root1, Node root2) {
        ...
        if(root1 != null && root2 != null){
            ...
            binaryTree.root.val = root1.val.hashCode()+root2.val.hashCode();

            binaryTree.root.left = merge2Trees(root1.left, root2.left);
            binaryTree.root.right = merge2Trees(root1.right, root2.right);
        }
